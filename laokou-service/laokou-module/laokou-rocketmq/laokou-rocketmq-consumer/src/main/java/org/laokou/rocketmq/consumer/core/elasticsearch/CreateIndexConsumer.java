...
@Slf4j
public class CreateIndexConsumer implements RocketMQListener<String> {
    ...
    public void onMessage(String message) {
        try {
            CreateIndexDTO createIndexDTO = JacksonUtil.toBean(message, CreateIndexDTO.class);
            elasticsearchApiFeignClient.create(createIndexDTO);

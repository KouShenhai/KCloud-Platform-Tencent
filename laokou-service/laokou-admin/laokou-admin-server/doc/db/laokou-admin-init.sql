...
INSERT INTO `boot_sys_menu` (`id`, `pid`, `permissions`, `type`, `name`, `url`, `auth_level`, `method`, `icon`, `creator`, `editor`, `create_date`, `update_date`, `del_flag`, `sort`) VALUES ('1545444197799067650', '1545036486288732162', 'workflow:definition:image', '1', '流程查看', '/workflow/definition/api/image', '0', 'GET', 'eyeOpen', '1537114827246292994', NULL, '2022-08-27 09:16:34', '2022-08-27 09:16:34', '0', '10');
...
INSERT INTO `boot_sys_menu` (`id`, `pid`, `permissions`, `type`, `name`, `url`, `auth_level`, `method`, `icon`, `creator`, `editor`, `create_date`, `update_date`, `del_flag`, `sort`) VALUES ('1563103435471122433', '1560529603300364290', 'sys:resource:audio:auditLog', '1', '音频审批日志', '/sys/resource/audio/api/auditLog', '0', 'POST', 'file', '1341620898007281665', '1341620898007281665', '2022-08-27 09:08:26', '2022-08-27 09:08:26', '0', '10');
INSERT INTO `boot_sys_menu` (`id`, `pid`, `permissions`, `type`, `name`, `url`, `auth_level`, `method`, `icon`, `creator`, `editor`, `create_date`, `update_date`, `del_flag`, `sort`) VALUES ('1563104611147116545', '1560530192751071234', 'sys:resource:video:auditLog', '1', '视频审批日志', '/sys/resource/video/api/auditLog', '0', 'POST', 'file', '1341620898007281665', '1341620898007281665', '2022-08-27 09:08:37', '2022-08-27 09:08:37', '0', '10');
INSERT INTO `boot_sys_menu` (`id`, `pid`, `permissions`, `type`, `name`, `url`, `auth_level`, `method`, `icon`, `creator`, `editor`, `create_date`, `update_date`, `del_flag`, `sort`) VALUES ('1563104888692600833', '1560530418819862529', 'sys:resource:image:auditLog', '1', '图片审批日志', '/sys/resource/image/api/auditLog', '0', 'POST', 'file', '1341620898007281665', '1341620898007281665', '2022-08-27 09:08:46', '2022-08-27 09:08:46', '0', '10');
INSERT INTO `boot_sys_menu` (`id`, `pid`, `permissions`, `type`, `name`, `url`, `auth_level`, `method`, `icon`, `creator`, `editor`, `create_date`, `update_date`, `del_flag`, `sort`) VALUES ('1563333871266885634', '1560530418819862529', 'sys:resource:image:detail', '1', '图片查看', '/sys/resource/image/api/detail', '0', 'GET', 'eyeOpen', '1341620898007281665', NULL, '2022-08-27 09:16:33', '2022-08-27 09:16:33', '0', '10');
INSERT INTO `boot_sys_menu` (`id`, `pid`, `permissions`, `type`, `name`, `url`, `auth_level`, `method`, `icon`, `creator`, `editor`, `create_date`, `update_date`, `del_flag`, `sort`) VALUES ('1563334139421323265', '1560530192751071234', 'sys:resource:video:detail', '1', '视频查看', '/sys/resource/video/api/detail', '0', 'GET', 'eyeOpen', '1341620898007281665', NULL, '2022-08-27 09:14:39', '2022-08-27 09:14:39', '0', '10');
INSERT INTO `boot_sys_menu` (`id`, `pid`, `permissions`, `type`, `name`, `url`, `auth_level`, `method`, `icon`, `creator`, `editor`, `create_date`, `update_date`, `del_flag`, `sort`) VALUES ('1563334404471975938', '1560529603300364290', 'sys:resource:audio:detail', '1', '音频查看', '/sys/resource/audio/api/detail', '0', 'GET', 'eyeOpen', '1341620898007281665', NULL, '2022-08-27 09:16:31', '2022-08-27 09:16:31', '0', '10');
INSERT INTO `boot_sys_menu` (`id`, `pid`, `permissions`, `type`, `name`, `url`, `auth_level`, `method`, `icon`, `creator`, `editor`, `create_date`, `update_date`, `del_flag`, `sort`) VALUES ('1564211460488826881', '1560529603300364290', 'sys:resource:audio:sync', '1', '音频同步', '/sys/resource/audio/api/sync', '0', 'POST', 'sync', '1341620898007281665', NULL, '2022-08-29 19:20:48', '2022-08-29 19:20:48', '0', '10');
INSERT INTO `boot_sys_menu` (`id`, `pid`, `permissions`, `type`, `name`, `url`, `auth_level`, `method`, `icon`, `creator`, `editor`, `create_date`, `update_date`, `del_flag`, `sort`) VALUES ('1564214128678539265', '1560530418819862529', 'sys:resource:image:sync', '1', '图片同步', '/sys/resource/image/api/sync', '0', 'POST', 'reload', '1341620898007281665', NULL, '2022-08-29 19:31:25', '2022-08-29 19:31:25', '0', '10');
INSERT INTO `boot_sys_menu` (`id`, `pid`, `permissions`, `type`, `name`, `url`, `auth_level`, `method`, `icon`, `creator`, `editor`, `create_date`, `update_date`, `del_flag`, `sort`) VALUES ('1564214393074880513', '1560530192751071234', 'sys:resource:video:sync', '1', '视频同步', '/sys/resource/video/api/sync', '0', 'POST', 'reload', '1341620898007281665', NULL, '2022-08-29 19:32:28', '2022-08-29 19:32:28', '0', '10');
INSERT INTO `boot_sys_menu` (`id`, `pid`, `permissions`, `type`, `name`, `url`, `auth_level`, `method`, `icon`, `creator`, `editor`, `create_date`, `update_date`, `del_flag`, `sort`) VALUES ('1564227439767920641', '1535878154046939137', 'sys:search:view', '0', '搜索管理', '/sys/search/view', '0', 'GET', 'ie', '1341620898007281665', '1341620898007281665', '2022-08-29 20:26:22', '2022-08-29 20:26:22', '0', '700');
INSERT INTO `boot_sys_menu` (`id`, `pid`, `permissions`, `type`, `name`, `url`, `auth_level`, `method`, `icon`, `creator`, `editor`, `create_date`, `update_date`, `del_flag`, `sort`) VALUES ('1564228322215927810', '1564227439767920641', 'sys:search:resource:view', '0', '资源搜索', '/sys/search/resource/view', '0', 'GET', 'loading', '1341620898007281665', NULL, '2022-08-29 20:27:49', '2022-08-29 20:27:49', '0', '100');
INSERT INTO `boot_sys_menu` (`id`, `pid`, `permissions`, `type`, `name`, `url`, `auth_level`, `method`, `icon`, `creator`, `editor`, `create_date`, `update_date`, `del_flag`, `sort`) VALUES ('1564996817056710657', '1564228322215927810', 'sys:search:resource:query', '1', '搜索资源', '/sys/search/api/resource', '0', 'POST', 'search', '1341620898007281665', NULL, '2022-08-31 23:21:32', '2022-08-31 23:21:32', '0', '10');
------------------------------------菜单------------------------------------

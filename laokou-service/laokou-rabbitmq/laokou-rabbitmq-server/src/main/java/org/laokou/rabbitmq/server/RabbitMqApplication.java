...
public class RabbitMqApplication {
    ...
    private static final String SERVICE_NAME = "laokou-rabbitmq-server";

    private static final String PACK_NAME = "org.laokou.rabbitmq.server".replaceAll("\\.", Matcher.quoteReplacement(File.separator));

    private static final String APPLICATION_NAME = "RabbitMqApplication";
